#ifndef FSIMNAIVE_NSDEF_H
#define FSIMNAIVE_NSDEF_H
...
///
/// Copyright (C) 2016, 2017, 2024 Yusuke Matsunaga
/// All rights reserved.
...
#if FSIM_VAL2
#  if FSIM_COMBI
#    define FSIM_NAMESPACE nsFsimNaiveCombi2
#    define FSIM_CLASSNAME FsimCombi2
#  elif FSIM_BSIDE
#    define FSIM_NAMESPACE nsFsimNaiveBside2
...
#elif FSIM_VAL3
#  if FSIM_COMBI
#    define FSIM_NAMESPACE nsFsimNaiveCombi3
#    define FSIM_CLASSNAME FsimCombi3
#  elif FSIM_BSIDE
#    define FSIM_NAMESPACE nsFsimNaiveBside3
