...
/// @file ColGraph_cube.cc
/// @brief ColGraph_cube の実装ファイル
...
SizeType
ColGraph_cube::saturation_degree(
  SizeType id
)
{
  SizeType sat = 0;
