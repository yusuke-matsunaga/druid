...
//////////////////////////////////////////////////////////////////////
/// @class DtpgStats DtpgStats.h "dtpg/DtpgStats.h"
...
private:
  ...
  /// @brief テスト生成に成功した回数．
  SizeType mDetCount{0};

  /// @brief テスト生成に成功した時の SAT に要した時間
  double mDetTime{0.0};

  /// @brief 冗長故障と判定した回数
  SizeType mUntestCount{0};

  /// @brief 冗長故障と判定した時の SAT に要した時間
  double mUntestTime{0.0};

  /// @brief アボートした回数
  SizeType mAbortCount{0};

  /// @brief アボートした時の SAT に要した時間
  double mAbortTime{0.0};

  /// @brief CNF 式を生成した回数
  SizeType mCnfGenCount{0};
  ...
  double mCnfGenTime{0.0};

  /// @brief バックトレースに要した時間
  double mBackTraceTime{0.0};
