...
""" PyTpgNodeList を生成するスクリプト

:file: tpgnodelist_gen.py
...
class TpgNodeListGen(PyObjGen):

    def __init__(self):
        super().__init__(classname='TpgNodeList',
                         pyname='TpgNodeList',
                         namespace='DRUID',
                         header_include_files=['types/TpgNodeList.h'],
                         source_include_files=['pym/PyTpgNodeList.h',
                                               'pym/PyTpgNode.h',
                                               'pym/PyUlong.h'])
