...
from .types_args import DffVectorArg


class DffVectorGen(PyObjGen):

    def __init__(self):
        super().__init__(classname='DffVector',
                         pyname='DffVector',
                         namespace='DRUID',
                         header_include_files=['types/DffVector.h'],
                         source_include_files=['pym/PyDffVector.h',
                                               'pym/PyAssignList.h',
                                               'pym/PyVal3.h',
                                               'pym/PyMt19937.h',
                                               'pym/PyString.h',
        ...
        self.add_method('check_compatible',
                        ...
                        arg_list=[DffVectorArg(name='right',
                                                 cvarname='right')],
        ...
        def meth_merge(writer):
            writer.gen_return_pyobject('PyDffVector',
                                       'val & right')
