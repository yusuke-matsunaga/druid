...
/// @brief TpgFault を Python から使用するための拡張
///
...
public:
  ...
  using ElemType = TpgFault;

public:

  /// @brief TpgFault を PyObject* に変換するファンクタクラス
  struct Conv {
    PyObject*
    operator()(
  ...
  /// @brief PyObject* から TpgFault を取り出すファンクタクラス
  struct Deconv {
    bool
    operator()(
...
public:
  ...
  {
    ElemType val;
    if ( PyTpgFault::FromPyObject(obj, val) ) {
      return val;
    }
